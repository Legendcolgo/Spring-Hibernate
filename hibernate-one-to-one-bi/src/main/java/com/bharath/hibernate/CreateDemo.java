...
public class CreateDemo {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            //Create the objects
            Instructor tempInstructor = new Instructor("Mathew", "Perry", "mathew.perry@gmail.com");

            InstructorDetail tempInstructorDetail = new InstructorDetail("http://www.youtube.com/johnnyVenom", "Sarcasm");
